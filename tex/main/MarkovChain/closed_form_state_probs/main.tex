...
\begin{multicols}{2}
    \begin{itemize}
        ...
        % \item (\ref{eq:00_rate_1141}) \( \Rightarrow \lambda^A (\lambda^o)^2\): \(G(1,2,0) = \binom{4-2}{2} = 1\)
        % \item (\ref{eq:00_rate_1141}) \( \Rightarrow 2 \lambda^A \lambda^o \mu \): \(G(1,1,1) = 4 - 1 - 1 = 2\)
        \item (\ref{eq:00_rate_1141}) \( \Rightarrow 3 \lambda^A \mu^2\): \(G(1,0,2) = 4 - 0 - 1 = 3\)
        % \item (\ref{eq:00_rate_1141}) \( \Rightarrow \mu^3\): \(G(0,0,3) = 1\)
        % \item (\ref{eq:00_rate_1151}) \( \Rightarrow (\lambda^A)^4\): \(G(4,0,0) = \binom{5-1}{0} = 1 \)
        \item (\ref{eq:00_rate_1151}) \( \Rightarrow 3 (\lambda^A)^3 \lambda^o\): \(G(3,1,0) = \binom{5-2}{1} = 3\)
        % \item (\ref{eq:00_rate_1151}) \( \Rightarrow 4 (\lambda^A)^3 \mu\): \(G(3,0,1) = \binom{5-1}{1} = 4\)
        ...
        % \item (\ref{eq:00_rate_1151}) \( \Rightarrow \lambda^A (\lambda^o)^3\): \(G(1,3,0) = 5 - 3 - 1 = 1\)
        % \item (\ref{eq:00_rate_1151}) \( \Rightarrow 2 \lambda^A (\lambda^o)^2 \mu\): \(G(0,0,3) = 5 - 2 - 1 = 2\)
        % \item (\ref{eq:00_rate_1151}) \( \Rightarrow 3 \lambda^A \lambda^o \mu \): \(G(0,0,3) = 5 - 1 - 1 = 3\)
        % \item (\ref{eq:00_rate_1151}) \( \Rightarrow 4 \lambda^A \mu^3 \): \(G(0,0,3) = 5 - 0 - 1 = 4\)
        % \item (\ref{eq:00_rate_1151}) \( \Rightarrow \mu^4\): \(G(0,0,4) = 1\)
    \end{itemize}
\end{multicols}
