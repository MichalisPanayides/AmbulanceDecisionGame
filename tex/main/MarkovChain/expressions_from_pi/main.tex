...
\subsubsection{Linear algebraic formula for mean blocking time}
...
A linear algebraic approach will be used to solve this equation here. 
...
\begin{multicols*}{2}
    \begin{figure}[H]
        \scalebox{0.65}{\input{MarkovChain/expressions_from_pi/example_model_2362/main.tex}}
