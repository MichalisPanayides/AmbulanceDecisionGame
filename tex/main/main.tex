...
\section{Markov Chain Representation}
...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[-, node distance = 1cm, auto]
        ...
        \draw[every loop]
            ...
            (three_one) edge[bend left] node {$\mu$} (three)
            (three_one) edge[bend left] node {$\lambda^o$} (four_one)
            (four_one) edge[bend left] node {$\mu$} (three_one)
            (four_one) edge[bend left] node {$\lambda^o$} (five_one)
            (five_one) edge[bend left] node {$\mu$} (four_one)
            ...
            (three_two) edge[bend left] node {$\mu$} (three_one)
            ...
            (four_two) edge[bend left] node {$\mu$} (three_two)
            (four_two) edge[bend left] node {$\lambda^o$} (five_two)
            (five_two) edge[bend left] node {$\mu$} (four_two)
            ;       
